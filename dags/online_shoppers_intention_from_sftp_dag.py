...
import io
import paramiko
from sqlalchemy import Table, Column, String, Integer,Float, MetaData, create_engine, text, UUID
import hashlib
...
endpointName="online_shoppers_intention"
target_table_name="online_shoppers_intention"
